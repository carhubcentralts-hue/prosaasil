...
🧾 יצירת הפרומפט
	...
	•	ברור ומדויק
	•	לא כללי - ספציפי לעסק
	•	לא ארוך מדי (400-800 מילים)
	•	לא רובוטי - טבעי וקולח
	•	מותאם לעסק ספציפי
	•	כולל הנחיות מפורשות על איך לנהל שיחה
	•	מגדיר מתי להעביר ללקוח אנושי
	•	מפרט איזה מידע לאסוף
	
הפרומפט צריך לכלול:
1. זהות הבוט ותפקידו
2. סגנון השיחה וטון הדיבור
3. מה לעשות ומה לא לעשות
4. איזה מידע לאסוף מהלקוח
5. מתי להעביר ללקוח אנושי
