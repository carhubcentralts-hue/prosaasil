        ...
        speech_contexts = [
            speech.SpeechContext(
                phrases=[
                    ...
                    # ⚡ BUILD 117: Hebrew numbers for accuracy
                    "אחד", "שניים", "שלוש", "ארבע", "חמש", "שש", "שבע", "שמונה", "תשע", "עשר",
                    "אחד עשר", "שנים עשר", "שלוש עשרה", "ארבע עשרה", "חמש עשרה",
                    "עשרים", "שלושים", "ארבעים", "חמישים", "מאה", "מאתיים",
                    "שלוש מאות", "ארבע מאות", "חמש מאות", "שש מאות",
                    # Common phrases
                    "אפשר", "בסדר", "מעניין", "נהדר", "מצוין"
                ],
                boost=20.0  # ✅ Higher boost for better accuracy
            )
        ]
