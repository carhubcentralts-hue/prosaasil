    ...
    def _config(self):
        ...
        speech_contexts = [
            speech.SpeechContext(
                phrases=[
                    # 🔥 BUILD 134: EXPANDED - More common Hebrew words for accuracy!
                    ...
                    # Locations
                    "תל אביב", "ירושלים", "חיפה", "באר שבע", "פתח תקווה", "רמת גן", "בני ברק",
                    "הרצליה", "ראשון לציון", "נתניה", "חולון", "בת ים", "רמלה", "לוד", "מודיעין",
                    # Money & numbers
                    ...
                    "בוקר", "צהריים", "אחר הצהריים", "ערב", "לילה", "שעה", "דקה",
                    # Common verbs
