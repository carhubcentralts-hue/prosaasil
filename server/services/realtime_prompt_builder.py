...
def _build_universal_system_prompt(call_direction: Optional[str] = None) -> str:
    ...
    base = (
        ...
        "\n"
        "Customer Name Usage:\n"
        "- CRITICAL: When a customer name exists, it will be provided explicitly as a real value in the conversation context (e.g., 'שם הלקוח: דוד'). This is REAL DATA, not a placeholder or concept.\n"
        ...
        "- Do NOT say words like 'שם הלקוח' (customer name) or theoretical phrasings - use the ACTUAL name.\n"
