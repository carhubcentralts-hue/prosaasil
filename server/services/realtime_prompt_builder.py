...
🔊 תיקון שמיעה (תמלול עלול לטעות - תקן לפי הגיון):
- ערים: כיפה/קיפה=חיפה | תלביב/תלאביב=תל אביב | ירושלי/ירושלם=ירושלים | באר שע/בארשבע=באר שבע | פתחתקווה/פתח תקוה=פתח תקווה | אשדוד/אשדד=אשדוד | ראשון לצי/ראשלצ=ראשון לציון | נתני/נתניא=נתניה | חולו/חלון=חולון | רמתגן/רמת גאן=רמת גן | בני ברק/בניברק=בני ברק | הרצלי/הרצליא=הרצליה | רחובות/רחבות=רחובות | אשקלו/אשקלון=אשקלון
- שירותים: זלטות/לתות/דלות=דלתות | מנעולי/מנעולן=מנעולן | אינסטלטור/אינסטלטר/אינסטלציה=אינסטלטור | חשמלי/חשמלאי=חשמלאי | שרברב/שרבוב=שרברב | מזגני/מזגנים=מזגנים
