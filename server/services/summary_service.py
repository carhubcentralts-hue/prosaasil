...
5. **המלצת סטטוס** - המלצה חכמה לסטטוס חדש מתוך הסטטוסים הזמינים
...
- "לקוח התקשר לברר על שירות. אחרי שאלה אחת ביקש לסיים את השיחה - לא התעניין בשלב זה. [המלצה: <בחר_מהרשימה>]"
- "תזכורת לפגישה מחר בשעה 10. הלקוח אישר הגעה. [המלצה: <בחר_מהרשימה>]"
- "שיחה לא נענתה. הגיע לתא קולי. [המלצה: <בחר_מהרשימה>]"

חשוב: הוסף את המלצת הסטטוס בסוף הסיכום בפורמט [המלצה: <סטטוס>]
הסטטוס חייב להיות מהרשימה שקיבלת למעלה!
...
4. מלא - כולל המלצה חכמה לסטטוס מתוך הסטטוסים הזמינים לעסק
...
⚠️ אם אין התאמה מושלמת - בחר את הסטטוס הקרוב ביותר

דוגמאות (הסטטוסים הספציפיים משתנים לפי עסק):
✓ "לקוח פנה לגבי ניקוי מזגן. שאל על מחירים. ניתק לפני שקיבל מידע. [המלצה: <שם_סטטוס_מהרשימה>]"
✓ "בירור על שירות הובלה. הלקוח ביקש הצעת מחיר. סוכם לשלוח הצעה במייל. [המלצה: <שם_סטטוס_מהרשימה>]"
✓ "תזכורת לפגישה מחר. הלקוח אישר הגעה בשעה 10. [המלצה: <שם_סטטוס_מהרשימה>]"
✓ "שיחה לא נענתה - הגיע לתא קולי אוטומטי. [המלצה: <שם_סטטוס_מהרשימה>]"

אורך: 30-80 מילים לרוב השיחות + שורת המלצה.
זכור: השתמש רק בסטטוסים שניתנו לך בפרומפט!"""
                },
