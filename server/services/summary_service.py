...
- "לקוח פנה בנושא ניקוי מזגן. ביקש לדעת מחירים. סוכם לחזור אליו עם הצעת מחיר."
- "לקוח התקשר לברר על שירות. אחרי שאלה אחת ביקש לסיים את השיחה - לא התעניין בשלב זה."
- "תזכורת לפגישה מחר בשעה 10. הלקוח אישר הגעה."
- "לקוח שאל על זמינות. לא מצאנו תאריך מתאים - יחזור אלינו בשבוע הבא."
...
דוגמאות:
✓ "לקוח פנה לגבי ניקוי מזגן. שאל על מחירים. ניתק לפני שקיבל מידע - לא התקדם."
✓ "בירור על שירות הובלה. הלקוח ביקש הצעת מחיר. סוכם לשלוח הצעה במייל."
✓ "תזכורת לפגישה מחר. הלקוח אישר הגעה בשעה 10."
✗ "שיחה טובה עם לקוח מעוניין" (חסר פרטים)

אורך: 30-80 מילים לרוב השיחות."""
                },
