...
def get_template_html(theme_id: str, fields: dict) -> str:
    """
    Generate HTML email from theme and fields
    ...
    Returns:
        Complete HTML email with theme styling
    """
    ...
    # Convert newlines to <br> tags in body
    ...
    <body style="background-color: {colors['background_color']}; margin: 0; padding: 20px;">
