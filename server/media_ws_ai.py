            ...
            def finalize_in_background():
                try:
                    ...
                    with app.app_context():
                        ...
                        # 🔥 WEBHOOK MOVED TO WORKER: Webhook now sent from tasks_recording.py after extraction completes
                        # This ensures city/service are always populated from offline extraction
                        # No need to send from here anymore - worker will send with full data after extraction
                        print(f"ℹ️ [WEBHOOK] Webhook will be sent by worker after offline processing completes")
