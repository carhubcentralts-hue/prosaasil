...
BUILD 119.3: RX Worker + Controlled STT Feeding at 20ms Cadence
"""
import os
import sys
...
print("=" * 80, flush=True)
print("🚀 ASGI BUILD 119.3 LOADING - RX WORKER + CONTROLLED STT FEEDING", flush=True)
print("=" * 80, flush=True)
...
print("=" * 80, flush=True)
print("✅ ASGI BUILD 119.3 READY - RX WORKER + 20MS CADENCE", flush=True)
print("=" * 80, flush=True)
