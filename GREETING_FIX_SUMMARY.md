...
- ✅ **הגנת ברכה משופרת:**
  ...
  - **שיחות נכנסות (INBOUND):** הגנה ל-500ms הראשונים, אז מאפשרים עם אישור טרנסקריפציה
- ✅ דרישה ל-transcription.completed או 250ms+ של קול רציף
- ✅ מניעת הפרעה מרעשים קצרים/הד
