...
- **Hebrew Transcription Hints (BUILD 188)**: Added phonetic correction hints to the AI system prompt. AI now auto-corrects common Whisper transcription errors: "כיפה"→"חיפה", "זלטות/לתות"→"דלתות", "תלביב"→"תל אביב", etc. Covers 15+ Israeli cities and common service types. Creative solution that fixes transcription at the AI logic layer without modifying STT.
