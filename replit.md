...
**⚡ BUILD 117 - Anti-Interruption + Complete Sentences Fix:**
- **AI Truncation Fixed**: First turn max increased from 24→60 words (~100 tokens) to prevent mid-sentence cuts like "...למשל"
...
- **Result**: Complete sentences with no mid-word cutoffs! Bot finishes all responses without false interruptions or AI truncation
