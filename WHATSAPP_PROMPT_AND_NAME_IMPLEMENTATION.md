...
### חשוב! הפרומפט הדיפולטיבי מינימלי

⚠️ **CRITICAL**: הפרומפט הדיפולטיבי של WhatsApp הוא מינימלי במכוון!

```python
אתה העוזר הדיגיטלי של {business_name} ב-WhatsApp.

תענה בעברית, תהיה חם ואדיב, ועזור ללקוח בהתאם לצרכיו.
```

**למה?**
- זה רק fallback חירום
- **כל הלוגיקה צריכה לבוא מה-DB!**
- אין לוגיקה קשיחה של פגישות, שירותים, או כל דבר ספציפי
- ⚠️ לא מתווספת אוטומטית לוגיקה של policy/appointments!

**איך להוסיף לוגיקה?**
עדכנו את `business.whatsapp_system_prompt` ב-DB עם הפרומפט המלא!
