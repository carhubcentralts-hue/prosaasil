                ...
                {attachments.map((att) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative p-3 border-2 rounded-lg hover:border-blue-300 transition ${
                        isSelected
                    ...
                    {/* Selected indicator */}
                    {isSelected && (
                      <div className="absolute top-1 left-1 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
