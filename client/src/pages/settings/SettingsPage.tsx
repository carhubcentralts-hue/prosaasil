      ...
      <div className="flex-1 overflow-y-auto p-6">
        {activeTab === 'business' && (
          <div className="max-w-2xl space-y-6">
            ...
            {/* BUILD 310: Only bot_speaks_first here - other settings moved to Call Control */}
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-500 text-center">הגדרות נוספות כמו ניתוק אוטומטי ותיאום פגישות נמצאות ב"הגדרות AI" → "הגדרות שליטת שיחה"</p>
              </div>
            </Card>
          </div>
        )}
