...
import { Settings, Save, Eye, EyeOff, Key, MessageCircle, Phone, Zap, Globe, Shield, Plus, Edit, Trash2, Link2, Bell, Bot } from 'lucide-react';
...
interface BusinessSettings {
  ...
  company_id?: string;  // ✅ Israeli company registration number (ח.פ)
  phone_number: string;
  email: string;
  address: string;
  ...
  useEffect(() => {
    if (businessData) {
      setBusinessSettings({
        ...
        company_id: businessData.company_id || '',  // ✅ Israeli company registration number
          ...
          <div className="max-w-2xl space-y-6">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">ח.פ (מספר עוסק)</label>
                  <input
                    type="text"
